...
export default (languages: Languages, hooks: Hook, util: Util) => {
    ...
    inside.string = languages.bash.string;
    inside['function'] = languages.bash['function'];
    inside.keyword = languages.bash.keyword;
    inside['boolean'] = languages.bash['boolean'];
    inside.operator = languages.bash.operator;
    inside.punctuation = languages.bash.punctuation;
